                ...
                <tbody class="table-group-divider">
                    ...
                    @foreach($usuarios as $row)
                        <tr>
                            ...
                            <td>{{ $row->carrera }}</td>
                            <td>
                                <a href="{{ url('carreras',[$row]) }}" class="btn btn-warning"><i class="fa-solid fa-edit">EDITAR</i></a>
                            </td>
                            <td>
                                <form method="POST" action="{{ url('carreras',[$row]) }}">
                                    @method("delete")
                                    @csrf
                                    <button class="btn btn-danger"><i class="fa-solid fa-trash">Eliminar</i></button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
